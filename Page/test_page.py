...
class Homepage():
    ...
    def __init__(self, driver):
        ...
        self.Pools = locate.Pools
        self.Pool_size = locate.Pool_size
        # self.deposit_click = locate.Deposit_click
        self.x_toke_value = locate.x_token_value
        self.y_toke_value = locate.y_token_value
        self.Error_element = locate.Error_element
    ...
    def x_toke_valuee(self):
        return self.x_toke_value
    
    def y_toke_valuee(self):
        return self.y_toke_value
    
    def Error_elementt(self):
